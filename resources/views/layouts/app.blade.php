...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark bg-primary shadow-sm p-3">
            <div class="container">
                <div class="navbar-brand-icon rotate-n-15"><i class="fas fa-business-time fa-lg" style="color:white"></i></div>
