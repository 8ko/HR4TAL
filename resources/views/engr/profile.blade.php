...
@include('layouts.flash-messages')
    ...
    <div class="card-body">
        <form method="post" id="form-requirement" enctype="multipart/form-data" action="{{ route('engr.requirement.store', $user->employee_id) }}"> 
        {{ csrf_field() }} 
    ...
    <div class="row">
        <div class="col">
            <div class="card shadow mb-3">
                ...
                <div class="card-body">
                    {{ Form::model($user,['engr.profile.update','id'=>'frm_profile']) }}
                    {{ csrf_field() }}
                    {{ method_field('PATCH') }}
                        <div class="row mb-3">
                            <div class="col">
